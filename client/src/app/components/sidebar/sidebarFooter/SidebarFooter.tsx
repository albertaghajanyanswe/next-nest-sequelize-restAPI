    ...
    <footer>
      <Box
        sx={{
          ...muiStyles.footer,
          ...(isSideBarOpen
            ? muiStyles.footerOpenedMode
            : muiStyles.footerClosedMode),
        }}
      >
        {isSideBarOpen && (
          <Box sx={muiStyles.footerTexts}>
        ...
        <Box
          sx={{
            ...muiStyles.footerCollapseAction,
            ...(isSideBarOpen ? muiStyles.footerActionOpenedMode : {}),
          }}
        >
          {isSideBarOpen ? (
            <ArrowBackIosOutlinedIcon
              sx={muiStyles.footerActionBtn}
